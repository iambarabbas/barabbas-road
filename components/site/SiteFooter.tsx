...
const FOOTER_LINKS = [
  ...
  { heading: "Grow",    items: [{ label: "Sermons",  href: "/sermons" }, { label: "Classes", href: "/classes" }, { label: "Kids", href: "/kids" }, { label: "Youth", href: "/youth" }] },
      ...
      <div className="brc-container" style={{ paddingTop: "64px", paddingBottom: "40px" }}>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "48px", justifyContent: "space-between" }}>
          ...
          <div style={{ maxWidth: "320px" }}>
            <Logo variant="white" markOnly height={68} />
