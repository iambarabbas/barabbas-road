...
export default function WhatWeBelievePage() {
  return (
    <div>
      ...
      <style>{`
.wwb-layout { display: grid; grid-template-columns: 1fr; gap: 0; }
.wwb-sidebar { display: none; }
.wwb-anchor { scroll-margin-top: 72px; }
.wwb-nav-group { font-family: var(--font-semicond); font-weight: 800; font-size: 10px; letter-spacing: .14em; text-transform: uppercase; color: var(--gold-700); margin: 20px 0 6px; padding-bottom: 6px; border-bottom: 1px solid var(--border-subtle); }
.wwb-nav-link { display: block; font-size: 13px; line-height: 1.4; color: var(--text-muted); text-decoration: none; padding: 4px 0; transition: color .15s; }
.wwb-nav-link:hover { color: var(--gold-700); }
@media (min-width: 900px) {
  .wwb-layout { grid-template-columns: 220px 1fr; gap: 56px; align-items: start; }
  .wwb-sidebar { display: block; position: sticky; top: 60px; max-height: calc(100vh - 72px); overflow-y: auto; scrollbar-width: thin; padding-right: 8px; }
}
`}</style>

      <section style={{ padding: "var(--section-y) 0", background: "var(--surface-page)" }}>
        <div className="brc-container">
          <div className="wwb-layout">

            {/* ── Sidebar Nav ── */}
            <aside className="wwb-sidebar">
              <nav>
                <div className="wwb-nav-group">Doctrinal Statement</div>
                <a className="wwb-nav-link" href="#holy-scriptures">The Holy Scriptures</a>
                <a className="wwb-nav-link" href="#godhead">The Godhead</a>
                <a className="wwb-nav-link" href="#father">Person and Work of the Father</a>
                <a className="wwb-nav-link" href="#christ">Person and Work of Christ</a>
                <a className="wwb-nav-link" href="#holy-spirit">The Holy Spirit</a>
                <a className="wwb-nav-link" href="#creation">Creation and Man</a>
                <a className="wwb-nav-link" href="#salvation">Salvation</a>
                <a className="wwb-nav-link" href="#eternal-security">Eternal Security</a>
                <a className="wwb-nav-link" href="#two-natures">Two Natures of the Believer</a>
                <a className="wwb-nav-link" href="#separation">Separation</a>
                <a className="wwb-nav-link" href="#missions">Missions</a>
                <a className="wwb-nav-link" href="#spiritual-gifts">Ministry &amp; Spiritual Gifts</a>
                <a className="wwb-nav-link" href="#dispensationalism">Dispensationalism</a>
                <a className="wwb-nav-link" href="#satan">Personality of Satan</a>
                <a className="wwb-nav-link" href="#second-advent">Second Advent of Christ</a>
                <a className="wwb-nav-link" href="#eternal-state">The Eternal State</a>

                <div className="wwb-nav-group">Position Papers</div>
                <a className="wwb-nav-link" href="#chicago-statement">Chicago Statement</a>
                <a className="wwb-nav-link" href="#sexuality-gender">Sexuality &amp; Gender</a>
                <a className="wwb-nav-link" href="#marriage-divorce">Marriage &amp; Divorce</a>
                <a className="wwb-nav-link" href="#men-women">Men &amp; Women</a>
              </nav>
            </aside>
            ...
            <div>
              ...
              <div style={{ maxWidth: "760px" }}>
                ...
                <h2 id="doctrinal-statement" className="wwb-anchor" style={{ fontSize: "clamp(1.8rem,1.2rem+1.5vw,2.4rem)", margin: "16px 0 40px", lineHeight: 1 }}>
                  What Barabbas Road Believes
                </h2>

                {DOCTRINE.map((article, i) => (
                  <div key={article.id} id={article.id} className="wwb-anchor" style={i < DOCTRINE.length - 1 ? sectionStyle : { marginBottom: 0 }}>
              ...
              {/* ── Chicago Statement ── */}
              <div style={{ borderTop: "1px solid var(--border-subtle)", paddingTop: "48px", marginTop: "48px" }}>
                <div style={{ maxWidth: "760px" }}>
                  <Eyebrow color="var(--gold-700)" withRule>Position Paper</Eyebrow>
                  <h2 id="chicago-statement" className="wwb-anchor" style={{ fontSize: "clamp(1.8rem,1.2rem+1.5vw,2.4rem)", margin: "16px 0 32px", lineHeight: 1 }}>
              ...
              <div style={{ borderTop: "1px solid var(--border-subtle)", paddingTop: "48px", marginTop: "48px" }}>
                <div style={{ maxWidth: "760px" }}>
                  <Eyebrow color="var(--gold-700)" withRule>Position Paper</Eyebrow>
                  <h2 id="sexuality-gender" className="wwb-anchor" style={{ fontSize: "clamp(1.8rem,1.2rem+1.5vw,2.4rem)", margin: "16px 0 24px", lineHeight: 1 }}>
              ...
              <div style={{ borderTop: "1px solid var(--border-subtle)", paddingTop: "48px", marginTop: "48px" }}>
                <div style={{ maxWidth: "760px" }}>
                  <Eyebrow color="var(--gold-700)" withRule>Position Paper</Eyebrow>
                  <h2 id="marriage-divorce" className="wwb-anchor" style={{ fontSize: "clamp(1.8rem,1.2rem+1.5vw,2.4rem)", margin: "16px 0 24px", lineHeight: 1 }}>
                    Marriage &amp; Divorce
                  </h2>
                  {[
              ...
              <div style={{ borderTop: "1px solid var(--border-subtle)", paddingTop: "48px", marginTop: "48px" }}>
                <div style={{ maxWidth: "760px" }}>
                  <Eyebrow color="var(--gold-700)" withRule>Position Paper</Eyebrow>
                  <h2 id="men-women" className="wwb-anchor" style={{ fontSize: "clamp(1.8rem,1.2rem+1.5vw,2.4rem)", margin: "16px 0 24px", lineHeight: 1 }}>
                    Men &amp; Women
                  </h2>
