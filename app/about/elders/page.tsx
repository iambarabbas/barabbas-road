...
const ELDERS = [
  ...
  },
  {
    ...
    bio: "Trace is originally from Chicago. He and his wife Jordan moved to San Diego in 2016 for a work relocation. He serves as the Pastor over the Children's Church ministry. Trace has a heart for evangelism and discipleship within the church and specifically with families. Trace has four young children, Wyatt, Charlotte, Wesley and Elliot. He enjoys cars, reading, hiking, and surfing.",
  },
];
      ...
      <section style={{ padding: "var(--section-y) 0", background: "var(--surface-page)" }}>
        <div className="brc-container">
          ...
          <blockquote style={{
            ...
            <p style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontSize: "17px", lineHeight: 1.7, color: "var(--text-body)", margin: "0 0 10px" }}>
            ...
            {ELDERS.map((elder) => (
              ...
              >
                <div style={{ marginBottom: "16px" }}>
                  <h2 style={{ fontSize: "26px", margin: "0 0 2px", lineHeight: 1.1 }}>{elder.name}</h2>
                  <div style={{
                ...
                <p style={{ color: "var(--text-body)", lineHeight: 1.7, margin: "0 0 16px", fontSize: "15.5px" }}>
                  {elder.bio}
                </p>
                <a
